<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewArtist.aspx.cs" Inherits="OnlineMusic.Admin.AddNewArtist" %>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
           ...
           <div class="formartist" style="text-align: right; padding: 20px;">
                
               <asp:Label ID="Label1" runat="server" Text="Artist Name:"></asp:Label>
               <asp:TextBox ID="txtbArtistName" runat="server"></asp:TextBox>
               <br />
               <asp:Label ID="Label2" runat="server" Text="ArtistSurname:"></asp:Label>
               <asp:TextBox ID="txtbArtistSurname" runat="server" style="margin-top: 10px; margin-bottom: 10px;"></asp:TextBox>
               <br />
               <asp:DropDownList ID="DropDownGenre" runat="server" OnSelectedIndexChanged="DropDownGenre_SelectedIndexChanged">
                   <asp:ListItem>RAP</asp:ListItem>
                   <asp:ListItem>ROCK</asp:ListItem>
                   <asp:ListItem></asp:ListItem>
               </asp:DropDownList>
               <br />
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:musicstoreConnectionString %>" SelectCommand="SELECT [GenreName] FROM [Genre]"></asp:SqlDataSource>
               <br />
               <asp:Button ID="btnSubmitArtist" runat="server" Text="Submit" class="btn-success" OnClick="btnSubmitArtist_Click"/>
        </div>
      </div>
          <!-- Content Row -->
