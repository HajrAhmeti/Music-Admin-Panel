<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewAlbum.aspx.cs" Inherits="OnlineMusic.Admin.AddNewAlbum" %>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Album new </h1>
          ...
          <div class="row">
           ...
           <div class="container">
               ...
               <br />
               <div class="m-2">
                   <asp:DropDownList ID="dropdownArtist" runat="server" DataSourceID="SqlDataSource1" class="dropdown-list" DataTextField="ArtistName" DataValueField="ArtistID" Height="33px" OnSelectedIndexChanged="dropdownArtist_SelectedIndexChanged" Width="294px" AutoPostBack="True" CssClass="btn-primary">
               </asp:DropDownList>
               </div>
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:musicstoreConnectionString %>" SelectCommand="SELECT * FROM [Artist]"></asp:SqlDataSource>
               <br />
&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Album Name"></asp:Label>
               &nbsp;&nbsp;<asp:TextBox ID="btnAddAlbum" runat="server"></asp:TextBox>
               <br />
               <br />
               <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Submit" CssClass="btn-primary" />
              </div>
          <!-- Content Row -->
